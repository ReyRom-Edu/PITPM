Вот подробная **инструкция по использованию `curl` в Windows для базового тестирования API**, рассчитанная на начинающих, но полезная и для студентов при выполнении лабораторных работ.
